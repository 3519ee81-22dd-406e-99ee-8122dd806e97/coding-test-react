...
import type { User } from "./userProfile/UserProfile";
...
const UserList = () => {
    const [users, setUsers] = useState<UserData[]>([]); // state 1   // Review : any 는 사용하지 말고 타입을 명확하게 UserData[] 명시
    ...
    useEffect(() => {
        fetchUsers()
            ...
            .catch((err) => console.error(err)); // Review : 실패할 수 있으니 error 띄어주기
    }, []);
