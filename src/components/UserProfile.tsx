...
import type { UserProfileProps } from "../types/type";
import UserProfileHeader from "./user-profile/UserProfileHeader";
import UserStatsSection from "./user-profile/UserStatsSection";
import UserPostsSection from "./user-profile/UserPostsSection";
